...
class Bug030_LaPuertaCompartidaSinRedEnAisladoTests(PruebaConRegistroAbierto):
    ...
    una mutación cómoda), `python manage.py test entrenos` SOLO sigue en `OK` — la
    coincidencia numérica de más arriba tapa el defecto (docs/bugs/030-la-puerta-compartida-
    sin-red-en-entrenos-y-cierres.md, sección 2).
